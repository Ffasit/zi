...
local COCAINE = io.open("COCAINE", 'w')
COCAINE:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 COCAINE.lua
done
]])
COCAINE:close()
...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S COCAINE -X kill
screen -S COCAINE ./COCAINE
done
]])
Run:close()
Redis:del(SshId.."Info:Redis:User:ID");Redis:del(SshId.."Info:Redis:User");Redis:del(SshId.."Info:Redis:Token:User");Redis:del(SshId.."Info:Redis:Token")
os.execute('chmod +x COCAINE;chmod +x Run;./Run')
end
...
COCAINE = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..COCAINE)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=COCAINE,token=Token}
function var(value)  
...
Status = 0
DevelopersQ = Redis:sismember(COCAINE.."COCAINE:DevelopersQ:Groups",UserId) 
Developers = Redis:sismember(COCAINE.."COCAINE:Developers:Groups",UserId) 
TheBasics = Redis:sismember(COCAINE.."COCAINE:TheBasics:Group"..ChatId,UserId) 
TheBasicsQ = Redis:sismember(COCAINE.."COCAINE:TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(COCAINE.."COCAINE:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(COCAINE.."COCAINE:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(COCAINE.."COCAINE:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(COCAINE.."COCAINE:Distinguished:Group"..ChatId,UserId)
...
Status = Redis:get(COCAINE.."COCAINE:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif DevelopersQ then
Status = Redis:get(COCAINE.."COCAINE:DevelopersQ:Groups"..ChatId) or 'المطور الثانوي'
elseif TheBasicsQ then
Status = Redis:get(COCAINE.."COCAINE:PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(COCAINE.."COCAINE:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(COCAINE.."COCAINE:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(COCAINE.."COCAINE:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(COCAINE.."COCAINE:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(COCAINE.."COCAINE:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(COCAINE.."COCAINE:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(COCAINE.."COCAINE:lockpin"..ChatId) then    
lock_pin = "【 ✅ 】"
else 
lock_pin = "【 ❌ 】"    
end
if Redis:get(COCAINE.."COCAINE:Lock:tagservr"..ChatId) then    
lock_tagservr = "【 ✅ 】"
else 
lock_tagservr = "【 ❌ 】"
end
if Redis:get(COCAINE.."COCAINE:Lock:text"..ChatId) then    
lock_text = "【 ✅ 】"
else 
lock_text = "【 ❌ 】 "    
end
if Redis:get(COCAINE.."COCAINE:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "【 ✅ 】"
else 
lock_add = "【 ❌ 】 "    
end    
if Redis:get(COCAINE.."COCAINE:Lock:Join"..ChatId) == "kick" then
lock_join = "【 ✅ 】"
else 
lock_join = "【 ❌ 】 "    
end    
if Redis:get(COCAINE.."COCAINE:Lock:edit"..ChatId) then    
lock_edit = "【 ✅ 】"
else 
lock_edit = "【 ❌ 】 "    
end
if Redis:get(COCAINE.."COCAINE:Chek:Welcome"..ChatId) then
welcome = "【 ✅ 】"
else 
welcome = "【 ❌ 】 "    
end
if Redis:hget(COCAINE.."COCAINE:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(COCAINE.."COCAINE:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(COCAINE.."COCAINE:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(COCAINE.."COCAINE:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "【 ✅ 】"
else     
flood = "【 ❌ 】 "     
end
if Redis:get(COCAINE.."COCAINE:Lock:Photo"..ChatId) == "del" then
lock_photo = "【 ✅ 】" 
elseif Redis:get(COCAINE.."COCAINE:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(COCAINE.."COCAINE:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(COCAINE.."COCAINE:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "【 ❌ 】 "   
end    
if Redis:get(COCAINE.."COCAINE:Lock:Contact"..ChatId) == "del" then
lock_phon = "【 ✅ 】" 
elseif Redis:get(COCAINE.."COCAINE:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(COCAINE.."COCAINE:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(COCAINE.."COCAINE:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "【 ❌ 】 "    
end    
if Redis:get(COCAINE.."COCAINE:Lock:Link"..ChatId) == "del" then
lock_links = "【 ✅ 】"
elseif Redis:get(COCAINE.."COCAINE:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(COCAINE.."COCAINE:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(COCAINE.."COCAINE:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "【 ❌ 】 "    
end
if Redis:get(COCAINE.."COCAINE:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "【 ✅ 】"
elseif Redis:get(COCAINE.."COCAINE:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(COCAINE.."COCAINE:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(COCAINE.."COCAINE:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "【 ❌ 】 "    
end
if Redis:get(COCAINE.."COCAINE:Lock:User:Name"..ChatId) == "del" then
lock_user = "【 ✅ 】"
elseif Redis:get(COCAINE.."COCAINE:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(COCAINE.."COCAINE:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(COCAINE.."COCAINE:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "【 ❌ 】 "    
end
if Redis:get(COCAINE.."COCAINE:Lock:hashtak"..ChatId) == "del" then
lock_hash = "【 ✅ 】"
elseif Redis:get(COCAINE.."COCAINE:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(COCAINE.."COCAINE:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(COCAINE.."COCAINE:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "【 ❌ 】 "    
end
if Redis:get(COCAINE.."COCAINE:Lock:vico"..ChatId) == "del" then
lock_muse = "【 ✅ 】"
elseif Redis:get(COCAINE.."COCAINE:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(COCAINE.."COCAINE:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(COCAINE.."COCAINE:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "【 ❌ 】 "    
end 
if Redis:get(COCAINE.."COCAINE:Lock:Video"..ChatId) == "del" then
lock_ved = "【 ✅ 】"
elseif Redis:get(COCAINE.."COCAINE:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(COCAINE.."COCAINE:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(COCAINE.."COCAINE:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "【 ❌ 】 "    
end
if Redis:get(COCAINE.."COCAINE:Lock:Animation"..ChatId) == "del" then
lock_gif = "【 ✅ 】"
elseif Redis:get(COCAINE.."COCAINE:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(COCAINE.."COCAINE:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(COCAINE.."COCAINE:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "【 ❌ 】 "    
end
if Redis:get(COCAINE.."COCAINE:Lock:Sticker"..ChatId) == "del" then
lock_ste = "【 ✅ 】"
elseif Redis:get(COCAINE.."COCAINE:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(COCAINE.."COCAINE:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(COCAINE.."COCAINE:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "【 ❌ 】 "    
end
if Redis:get(COCAINE.."COCAINE:Lock:geam"..ChatId) == "del" then
lock_geam = "【 ✅ 】"
elseif Redis:get(COCAINE.."COCAINE:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(COCAINE.."COCAINE:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(COCAINE.."COCAINE:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "【 ❌ 】 "    
end    
...
if Redis:get(COCAINE.."COCAINE:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "【 ✅ 】"
elseif Redis:get(COCAINE.."COCAINE:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(COCAINE.."COCAINE:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(COCAINE.."COCAINE:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "【 ❌ 】 "
end
if Redis:get(COCAINE.."COCAINE:Lock:forward"..ChatId) == "del" then
lock_fwd = "【 ✅ 】"
elseif Redis:get(COCAINE.."COCAINE:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(COCAINE.."COCAINE:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(COCAINE.."COCAINE:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "【 ❌ 】 "    
end    
if Redis:get(COCAINE.."COCAINE:Lock:Document"..ChatId) == "del" then
lock_file = "【 ✅ 】"
elseif Redis:get(COCAINE.."COCAINE:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(COCAINE.."COCAINE:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(COCAINE.."COCAINE:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "【 ❌ 】 "    
end    
if Redis:get(COCAINE.."COCAINE:Lock:Unsupported"..ChatId) == "del" then
lock_self = "【 ✅ 】"
elseif Redis:get(COCAINE.."COCAINE:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(COCAINE.."COCAINE:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(COCAINE.."COCAINE:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "【 ❌ 】 "    
end
if Redis:get(COCAINE.."COCAINE:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "【 ✅ 】"
elseif Redis:get(COCAINE.."COCAINE:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(COCAINE.."COCAINE:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "【 ❌ 】 "    
end
if Redis:get(COCAINE.."COCAINE:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "【 ✅ 】"
elseif Redis:get(COCAINE.."COCAINE:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(COCAINE.."COCAINE:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(COCAINE.."COCAINE:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "【 ❌ 】 "    
end
if Redis:get(COCAINE.."COCAINE:Lock:Spam"..ChatId) == "del" then    
lock_spam = "【 ✅ 】"
elseif Redis:get(COCAINE.."COCAINE:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(COCAINE.."COCAINE:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(COCAINE.."COCAINE:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "【 ❌ 】 "    
end        
...
{
{text = '𖠋 اخفاء الامر 𖠋', data =IdUser..'/'.. '/delAmr'}
},
}
}
...
return{
BanAll = Redis:sismember(COCAINE.."COCAINE:BanAll:Groups",UserId) ,
ktmall = Redis:sismember(COCAINE.."COCAINE:ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(COCAINE.."COCAINE:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(COCAINE.."COCAINE:SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,COCAINE).status
if GetMemberStatus.can_change_info then
...
local msg_id = msg.id
Redis:incr(COCAINE..'COCAINE:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == tonumber(COCAINE) then
...
if tonumber(msg.sender.user_id) == 1804133252 then
...
elseif Redis:sismember(COCAINE.."COCAINE:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(COCAINE.."COCAINE:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(COCAINE.."COCAINE:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(COCAINE.."COCAINE:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(COCAINE.."COCAINE:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(COCAINE.."COCAINE:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(COCAINE.."COCAINE:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(COCAINE.."COCAINE:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(COCAINE.."COCAINE:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(COCAINE.."COCAINE:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(COCAINE.."COCAINE:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(COCAINE.."COCAINE:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(COCAINE.."COCAINE:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(COCAINE.."COCAINE:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(COCAINE.."COCAINE:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(COCAINE) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(COCAINE.."COCAINE:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(COCAINE.."COCAINE:Lock:text"..msg_chat_id) and not msg.Distinguished then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(COCAINE.."COCAINE:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(COCAINE) then
return false
end
local floods = Redis:hget(COCAINE.."COCAINE:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(COCAINE.."COCAINE:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(COCAINE.."COCAINE:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(COCAINE.."COCAINE:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(COCAINE.."COCAINE:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(COCAINE.."COCAINE:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(COCAINE.."COCAINE:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(COCAINE.."COCAINE:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(COCAINE.."COCAINE:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(COCAINE.."COCAINE:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(COCAINE.."COCAINE:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(COCAINE.."COCAINE:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(COCAINE.."COCAINE:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(COCAINE.."COCAINE:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Developers then -- التوجيه
local Fwd_Group = Redis:get(COCAINE.."COCAINE:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(COCAINE.."COCAINE:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(COCAINE.."COCAINE:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(COCAINE.."COCAINE:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(COCAINE.."COCAINE:lockpin"..msg_chat_id)
...
Redis:incr(COCAINE.."COCAINE:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(COCAINE.."COCAINE:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(COCAINE.."COCAINE:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(COCAINE.."COCAINE:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(COCAINE.."COCAINE:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(COCAINE.."COCAINE:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(COCAINE.."COCAINE:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(COCAINE.."COCAINE:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(COCAINE.."COCAINE:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(COCAINE.."COCAINE:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(COCAINE.."COCAINE:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(COCAINE.."COCAINE:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(COCAINE.."COCAINE:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(COCAINE.."COCAINE:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(COCAINE.."COCAINE:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(COCAINE.."COCAINE:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(COCAINE.."COCAINE:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(COCAINE.."COCAINE:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(COCAINE.."COCAINE:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(COCAINE.."COCAINE:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(COCAINE..'COCAINE:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(COCAINE.."COCAINE:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(COCAINE.."COCAINE:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(COCAINE.."COCAINE:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(COCAINE.."COCAINE:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(COCAINE.."COCAINE:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(COCAINE.."COCAINE:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(COCAINE.."COCAINE:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(COCAINE.."COCAINE:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(COCAINE..'COCAINE:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n ⦁ ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(COCAINE..'COCAINE:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(COCAINE.."COCAINE:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(COCAINE.."COCAINE:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(COCAINE.."COCAINE:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(COCAINE..'COCAINE:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n ⦁ تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(COCAINE..'COCAINE:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(COCAINE.."COCAINE:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(COCAINE.."COCAINE:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(COCAINE.."COCAINE:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(COCAINE.."COCAINE:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(COCAINE.."COCAINE:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(COCAINE.."COCAINE:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(COCAINE.."COCAINE:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(COCAINE.."COCAINE:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(COCAINE..'COCAINE:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(COCAINE.."COCAINE:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(COCAINE.."COCAINE:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(COCAINE.."COCAINE:All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(COCAINE.."COCAINE:All:Get:Reides:Commands:Group"..text)
Redis:del(COCAINE.."COCAINE:All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(COCAINE.."COCAINE:All:Command:List:Group",text)
...
Redis:del(COCAINE.."COCAINE:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(COCAINE.."COCAINE:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(COCAINE.."COCAINE:All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(COCAINE.."COCAINE:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(COCAINE.."COCAINE:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(COCAINE.."COCAINE:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(COCAINE.."COCAINE:All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(COCAINE.."COCAINE:All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(COCAINE.."COCAINE:All:Command:List:Group",text)
Redis:del(COCAINE.."COCAINE:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم حفظ الامر باسم ⇦ { "..text..' }',"md",true)
end

if text and Redis:get(COCAINE.."COCAINE:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(COCAINE.."COCAINE:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(COCAINE.."COCAINE:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(COCAINE.."COCAINE:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(COCAINE.."COCAINE:Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم ازالة هاذا ⇦ { "..text.." }","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id," ⦁ لا يوجد امر بهاذا الاسم","md",true)
end
Redis:del(COCAINE.."COCAINE:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(COCAINE.."COCAINE:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(COCAINE.."COCAINE:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(COCAINE.."COCAINE:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(COCAINE.."COCAINE:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(COCAINE.."COCAINE:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(COCAINE.."COCAINE:Command:Reids:Group:New"..msg_chat_id)
Redis:set(COCAINE.."COCAINE:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(COCAINE.."COCAINE:Command:List:Group"..msg_chat_id,text)
Redis:del(COCAINE.."COCAINE:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم حفظ الامر باسم ⇦ { "..text..' }',"md",true)
end
if Redis:get(COCAINE.."COCAINE:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(COCAINE.."COCAINE:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(COCAINE.."COCAINE:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(COCAINE.."COCAINE:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(COCAINE.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(COCAINE.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(COCAINE.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(COCAINE.."COCAINE:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(COCAINE.."COCAINE:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(COCAINE.."COCAINE:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(COCAINE.."COCAINE:Group:Rules" .. msg_chat_id,text) 
Redis:del(COCAINE.."COCAINE:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(COCAINE.."COCAINE:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(COCAINE.."COCAINE:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if text  then
local test = Redis:get(COCAINE.."COCAINE:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(COCAINE.."COCAINE:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(COCAINE.."COCAINE:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(COCAINE.."COCAINE:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(COCAINE.."COCAINE:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(COCAINE.."COCAINE:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم حفظ في قائمه الردود *\n* ⦁ ارسل『"..test.."』لرئية الرد*","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(COCAINE.."COCAINE:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(COCAINE.."COCAINE:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(COCAINE.."COCAINE:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(COCAINE.."COCAINE:List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(COCAINE.."COCAINE:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(COCAINE.."COCAINE:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(COCAINE.."COCAINE:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم حذف الرد في قائمه الردود *","md",true)  
return false
end
end
if text and Redis:get(COCAINE.."COCAINE:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(COCAINE.."COCAINE:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(COCAINE.."COCAINE:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(COCAINE.."COCAINE:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(COCAINE.."COCAINE:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(COCAINE.."COCAINE:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(COCAINE.."COCAINE:Add:Rd:Sudo:Video"..text)
local document = Redis:get(COCAINE.."COCAINE:Add:Rd:Sudo:File"..text)
...
if text and Redis:get(COCAINE.."COCAINE:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(COCAINE.."COCAINE:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(COCAINE.."COCAINE:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(COCAINE.."COCAINE:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(COCAINE.."COCAINE:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(COCAINE.."COCAINE:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(COCAINE.."COCAINE:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(COCAINE.."COCAINE:Add:Rd:Manager:File"..text..msg_chat_id)
...
if text then
local test = Redis:get(COCAINE.."COCAINE:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(COCAINE.."COCAINE:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(COCAINE.."COCAINE:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(COCAINE.."COCAINE:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(COCAINE.."COCAINE:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(COCAINE.."COCAINE:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(COCAINE.."COCAINE:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text and text:match("^(.*)$") then
if Redis:get(COCAINE.."COCAINE:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(COCAINE.."COCAINE:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(COCAINE.."COCAINE:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(COCAINE.."COCAINE:List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
if text and text:match("^(.*)$") then
if Redis:get(COCAINE.."COCAINE:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(COCAINE..'COCAINE:'..v..text)
end
Redis:del(COCAINE.."COCAINE:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(COCAINE.."COCAINE:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم حذف الرد في الردود العامه *","md",true)  
end
end
if Redis:get(COCAINE.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(COCAINE.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n* ⦁ تم الغاء الاذاعه بالتثبيت*","md",true)  
end 
local list = Redis:smembers(COCAINE.."COCAINE:ChekBotAdd") 
...
if Redis:get(COCAINE.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(COCAINE.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⦁  تم الغاء الاذاعه بالتوجيه للخاص","md",true)    
end 
if msg.forward_info then 
local list = Redis:smembers(COCAINE.."COCAINE:Num:User:Pv") 
...
if Redis:get(COCAINE.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(COCAINE.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(COCAINE.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(COCAINE.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(COCAINE.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(COCAINE.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(COCAINE..'COCAINE:GetTexting:DevCOCAINE'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == '『 الغاء الامر 』' then 
Redis:del(COCAINE..'COCAINE:GetTexting:DevCOCAINE'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,' ⦁ تم الغاء حفظ كليشة المطور')
end
Redis:set(COCAINE..'COCAINE:Texting:DevCOCAINE',text)
Redis:del(COCAINE..'COCAINE:GetTexting:DevCOCAINE'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,' ⦁ تم حفظ كليشة المطور')
end
if Redis:get(COCAINE.."COCAINE:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ⦁ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(COCAINE.."COCAINE:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(COCAINE.."COCAINE:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(COCAINE.."COCAINE:Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ⦁ تم تعين الايدي عام',"md",true)  
end
if Redis:get(COCAINE.."COCAINE:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ⦁ تم الغاء امر تعين الايدي","md",true)  
Redis:del(COCAINE.."COCAINE:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(COCAINE.."COCAINE:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(COCAINE.."COCAINE:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ⦁ تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(COCAINE.."COCAINE:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(COCAINE.."COCAINE:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n ⦁ تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(COCAINE.."COCAINE:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(COCAINE.."COCAINE:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, " ⦁ تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(COCAINE.."COCAINE:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(COCAINE.."COCAINE:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n ⦁ تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(COCAINE.."COCAINE:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(COCAINE.."COCAINE:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, " ⦁ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(COCAINE.."COCAINE:Game:Smile"..msg.chat_id) then
if text == Redis:get(COCAINE.."COCAINE:Game:Smile"..msg.chat_id) then
Redis:incrby(COCAINE.."COCAINE:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(COCAINE.."COCAINE:Game:Smile"..msg.chat_id)
...
if Redis:get(COCAINE.."COCAINE:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(COCAINE.."COCAINE:Game:Monotonous"..msg.chat_id) then
Redis:del(COCAINE.."COCAINE:Game:Monotonous"..msg.chat_id)
Redis:incrby(COCAINE.."COCAINE:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(COCAINE.."COCAINE:Game:Riddles"..msg.chat_id) then
if text == Redis:get(COCAINE.."COCAINE:Game:Riddles"..msg.chat_id) then
Redis:incrby(COCAINE.."COCAINE:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(COCAINE.."COCAINE:Game:Riddles"..msg.chat_id)
...
if Redis:get(COCAINE.."COCAINE:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(COCAINE.."COCAINE:Game:Meaningof"..msg.chat_id) then
Redis:incrby(COCAINE.."COCAINE:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(COCAINE.."COCAINE:Game:Meaningof"..msg.chat_id)
...
if Redis:get(COCAINE.."COCAINE:Game:Reflection"..msg.chat_id) then
if text == Redis:get(COCAINE.."COCAINE:Game:Reflection"..msg.chat_id) then
Redis:incrby(COCAINE.."COCAINE:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(COCAINE.."COCAINE:Game:Reflection"..msg.chat_id)
...
if Redis:get(COCAINE.."COCAINE:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ عذرا لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(COCAINE.."COCAINE:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(COCAINE.."COCAINE:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(COCAINE.."COCAINE:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(COCAINE.."COCAINE:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(COCAINE.."COCAINE:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(COCAINE.."COCAINE:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(COCAINE.."COCAINE:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(COCAINE.."COCAINE:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(COCAINE.."COCAINE:Game:Difference"..msg.chat_id) then
if text == Redis:get(COCAINE.."COCAINE:Game:Difference"..msg.chat_id) then 
Redis:del(COCAINE.."COCAINE:Game:Difference"..msg.chat_id)
Redis:incrby(COCAINE.."COCAINE:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(COCAINE.."COCAINE:Game:Example"..msg.chat_id) then
if text == Redis:get(COCAINE.."COCAINE:Game:Example"..msg.chat_id) then 
Redis:del(COCAINE.."COCAINE:Game:Example"..msg.chat_id)
Redis:incrby(COCAINE.."COCAINE:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text then
local NewCmmd = Redis:get(COCAINE.."COCAINE:All:Get:Reides:Commands:Group"..text) or Redis:get(COCAINE.."COCAINE:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
if tonumber(COCAINE) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,' ⦁ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(COCAINE..'COCAINE:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(COCAINE.."COCAINE:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(COCAINE.."COCAINE:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(COCAINE.."COCAINE:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(COCAINE.."COCAINE:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(COCAINE.."COCAINE:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(COCAINE.."COCAINE:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(COCAINE) then 
return LuaTele.sendText(msg_chat_id,msg_id,' ⦁ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(COCAINE.."COCAINE:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(COCAINE.."COCAINE:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(COCAINE.."COCAINE:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(COCAINE.."COCAINE:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(COCAINE.."COCAINE:TheBasics:Group"..idg,idASAS)
end;end
end
...
--os.execute('rm -rf COCAINE.lua')
--download('https://raw.githubusercontent.com/M2007A/JEKA/master/COCAINE.lua','COCAINE.lua')
...
Redis:del(COCAINE.."COCAINE:SendBcBot") 
...
Redis:set(COCAINE.."COCAINE:SendBcBot",true) 
...
Redis:del(COCAINE.."COCAINE:LeftBot") 
...
Redis:set(COCAINE.."COCAINE:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(COCAINE.."COCAINE:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(COCAINE.."COCAINE:AddSudosNew"..msg_chat_id)
...
Redis:set(COCAINE.."COCAINE:AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(COCAINE..'COCAINE:ChekBotAdd')  
local UsersBot = Redis:smembers(COCAINE..'COCAINE:Num:User:Pv')  
local Get_Json = '{"BotId": '..COCAINE..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(COCAINE.."COCAINE:TheBasics:Group"..v)
local Constructor = Redis:smembers(COCAINE.."COCAINE:Originators:Group"..v)
local Manager = Redis:smembers(COCAINE.."COCAINE:Managers:Group"..v)
local Admin = Redis:smembers(COCAINE.."COCAINE:Addictive:Group"..v)
local Vips = Redis:smembers(COCAINE.."COCAINE:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
Redis:set(COCAINE..'COCAINE:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
Groups = (Redis:scard(COCAINE..'COCAINE:ChekBotAdd') or 0)
Users = (Redis:scard(COCAINE..'COCAINE:Num:User:Pv') or 0)
...
{
{text = Jabwa, url = 't.me/Escobar_source'}, 
},
{
{text = Grosupsw, url = 't.me/Escobar_source'}, 
},
{
{text = Usperos, url = 't.me/Escobar_source'}, 
},
}
...
if Redis:sismember(COCAINE.."COCAINE:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(COCAINE..'COCAINE:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,' ⦁ عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(COCAINE..'COCAINE:Num:Add:Bot'),"md",true)  
end
...
data = {
{
{text = '𖠋 ترقيه المالك والادمنيه 𖠋', data = msg.sender.user_id..'/addAdmins@'..msg_chat_id},
},
{
{text = '𖠋 قفل جميع الاوامر 𖠋', data =msg.sender.user_id..'/LockAllGroup@'..msg_chat_id},
},
{
{text = '𖠋 اوامر الحمايه المجموعه 𖠋', data =msg.sender.user_id..'/listallAddorr@'..msg_chat_id},
},
}
}
if not msg.ControllerBot then
...
{
{text = '𖠋 مغادرة المجموعه 𖠋', data = '/Zxchq'..msg_chat_id}, 
},
}
}
...
if not Redis:get(COCAINE.."COCAINE:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(COCAINE.."COCAINE:ChekBotAdd",msg_chat_id) then
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(COCAINE.."COCAINE:ChekBotAdd",msg_chat_id) then
...
local NumberGames = Redis:get(COCAINE.."COCAINE:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
...
local TotalMsg = Redis:get(COCAINE..'COCAINE:Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(COCAINE..'COCAINE:Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(COCAINE.."COCAINE:Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(COCAINE.."COCAINE:Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
if text == 'رتبتي' then
if not Redis:get(COCAINE.."COCAINE:photo:Rank"..msg_chat_id) then
return false
end
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,COCAINE).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,' ⦁ البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,COCAINE).status
if GetMemberStatus.can_change_info then
change_info = '【 ✅ 】' else change_info = '【 ❌ 】'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(COCAINE.."COCAINE:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"* ⦁ تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(COCAINE.."COCAINE:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(COCAINE.."COCAINE:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(COCAINE.."COCAINE:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(COCAINE.."COCAINE:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(COCAINE.."COCAINE:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(COCAINE.."COCAINE:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(COCAINE.."COCAINE:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(COCAINE.."COCAINE:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(COCAINE.."COCAINE:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(COCAINE.."COCAINE:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(COCAINE.."COCAINE:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(COCAINE.."COCAINE:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(COCAINE.."COCAINE:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(COCAINE.."COCAINE:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(COCAINE.."COCAINE:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(COCAINE.."COCAINE:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(COCAINE.."COCAINE:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(COCAINE.."COCAINE:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(COCAINE.."COCAINE:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(COCAINE.."COCAINE:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(COCAINE.."COCAINE:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(COCAINE.."COCAINE:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(COCAINE.."COCAINE:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(COCAINE.."COCAINE:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(COCAINE.."COCAINE:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(COCAINE.."COCAINE:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(COCAINE.."COCAINE:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(COCAINE.."COCAINE:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(COCAINE.."COCAINE:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(COCAINE.."COCAINE:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(COCAINE.."COCAINE:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(COCAINE.."COCAINE:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"* ⦁ تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(COCAINE.."COCAINE:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(COCAINE.."COCAINE:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(COCAINE.."COCAINE:Developers:Groups",UserId) 
...
if not Redis:sismember(COCAINE.."COCAINE:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(COCAINE.."COCAINE:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(COCAINE.."COCAINE:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(COCAINE.."COCAINE:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(COCAINE.."COCAINE:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(COCAINE.."COCAINE:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(COCAINE.."COCAINE:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(COCAINE.."COCAINE:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(COCAINE.."COCAINE:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(COCAINE.."COCAINE:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(COCAINE.."COCAINE:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(COCAINE.."COCAINE:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(COCAINE.."COCAINE:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(COCAINE.."COCAINE:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(COCAINE.."COCAINE:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(COCAINE.."COCAINE:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(COCAINE.."COCAINE:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(COCAINE.."COCAINE:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(COCAINE.."COCAINE:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(COCAINE.."COCAINE:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(COCAINE.."COCAINE:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(COCAINE.."COCAINE:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(COCAINE.."COCAINE:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
Redis:sadd(COCAINE.."COCAINE:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(COCAINE.."COCAINE:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(COCAINE.."COCAINE:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(COCAINE.."COCAINE:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(COCAINE.."COCAINE:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(COCAINE.."COCAINE:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(COCAINE.."COCAINE:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(COCAINE.."COCAINE:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(COCAINE.."COCAINE:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(COCAINE.."COCAINE:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:Developers:Groups",UserId) 
...
if Redis:sismember(COCAINE.."COCAINE:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(COCAINE.."COCAINE:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(COCAINE.."COCAINE:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(COCAINE.."COCAINE:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(COCAINE.."COCAINE:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(COCAINE.."COCAINE:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(COCAINE.."COCAINE:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(COCAINE.."COCAINE:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(COCAINE.."COCAINE:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(COCAINE.."COCAINE:PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(COCAINE.."COCAINE:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(COCAINE.."COCAINE:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(COCAINE.."COCAINE:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(COCAINE.."COCAINE:DevelopersQ:Groups") 
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𖠋 مسح الثانوين 𖠋', data = msg.sender.user_id..'/DevelopersQ'},},}}
...
local Info_Members = Redis:smembers(COCAINE.."COCAINE:Developers:Groups") 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𖠋 مسح المطورين 𖠋', data = msg.sender.user_id..'/Developers'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Info_Members = Redis:smembers(COCAINE.."COCAINE:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𖠋 مسح المالكين 𖠋', data = msg.sender.user_id..'/TheBasicsQ'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Info_Members = Redis:smembers(COCAINE.."COCAINE:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𖠋 مسح المنشئين الاساسيين 𖠋', data = msg.sender.user_id..'/TheBasics'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Info_Members = Redis:smembers(COCAINE.."COCAINE:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𖠋 مسح المنشئين 𖠋', data = msg.sender.user_id..'/Originators'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Info_Members = Redis:smembers(COCAINE.."COCAINE:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𖠋 مسح المدراء 𖠋', data = msg.sender.user_id..'/Managers'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Info_Members = Redis:smembers(COCAINE.."COCAINE:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𖠋 مسح الادمنيه 𖠋', data = msg.sender.user_id..'/Addictive'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Info_Members = Redis:smembers(COCAINE.."COCAINE:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𖠋 مسح المميزين 𖠋', data = msg.sender.user_id..'/DelDistinguished'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Info_Members = Redis:smembers(COCAINE.."COCAINE:BanAll:Groups") 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𖠋 مسح المحظورين عام 𖠋', data = msg.sender.user_id..'/BanAll'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Info_Members = Redis:smembers(COCAINE.."COCAINE:ktmAll:Groups") 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𖠋 مسح المكتومين عام 𖠋', data = msg.sender.user_id..'/ktmAll'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Info_Members = Redis:smembers(COCAINE.."COCAINE:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𖠋 مسح المحظورين 𖠋', data = msg.sender.user_id..'/BanGroup'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Info_Members = Redis:smembers(COCAINE.."COCAINE:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𖠋 مسح المكتومين 𖠋', data = msg.sender.user_id..'/SilentGroupGroup'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
Redis:set(COCAINE.."COCAINE:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم تفعيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(COCAINE.."COCAINE:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(COCAINE.."COCAINE:Status:Id"..msg_chat_id,true) 
...
Redis:set(COCAINE.."COCAINE:Zhrf:Sasa"..msg_chat_id,true) 
...
Redis:set(COCAINE.."COCAINE:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(COCAINE.."COCAINE:photo:Rank"..msg_chat_id,true) 
...
Redis:set(COCAINE.."COCAINE:Status:Reply"..msg_chat_id,true) 
...
Redis:set(COCAINE.."COCAINE:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(COCAINE.."COCAINE:Status:BanId"..msg_chat_id,true) 
...
Redis:set(COCAINE.."COCAINE:Status:remMe"..msg_chat_id,true) 
...
Redis:set(COCAINE.."COCAINE:BotFree",true) 
...
Redis:set(COCAINE.."COCAINE:TwaslBot",true) 
...
if TextMsg == 'الرابط' then
Redis:del(COCAINE.."COCAINE:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم تعطيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(COCAINE.."COCAINE:Status:Welcome"..msg_chat_id) 
...
Redis:del(COCAINE.."COCAINE:Zhrf:Sasa"..msg_chat_id) 
...
Redis:del(COCAINE.."COCAINE:Status:Id"..msg_chat_id) 
...
Redis:del(COCAINE.."COCAINE:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(COCAINE.."COCAINE:photo:Rank"..msg_chat_id) 
...
Redis:del(COCAINE.."COCAINE:Status:Reply"..msg_chat_id) 
...
Redis:del(COCAINE.."COCAINE:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(COCAINE.."COCAINE:Status:BanId"..msg_chat_id) 
...
Redis:del(COCAINE.."COCAINE:Status:SetId"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم تعطيل الرفع *","md",true)
end
if TextMsg == 'الالعاب' then
Redis:del(COCAINE.."COCAINE:Status:Games"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم تعطيل الالعاب *","md",true)
end
if TextMsg == 'التحقق' then
    Redis:del(COCAINE.."COCAINE:Status:joinet"..msg_chat_id) 
...
if TextMsg == 'نزلني' then
Redis:del(COCAINE.."COCAINE:Status:remMe"..msg_chat_id) 
...
Redis:del(COCAINE.."COCAINE:BotFree") 
...
Redis:del(COCAINE.."COCAINE:TwaslBot") 
...
if Redis:sismember(COCAINE.."COCAINE:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(COCAINE.."COCAINE:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(COCAINE.."COCAINE:BanAll:Groups",UserId_Info.id) 
...
Redis:sadd(COCAINE.."COCAINE:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(COCAINE.."COCAINE:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(COCAINE.."COCAINE:ktmAll:Groups",UserId_Info.id) 
...
if Redis:sismember(COCAINE.."COCAINE:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(COCAINE.."COCAINE:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(COCAINE.."COCAINE:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(COCAINE.."COCAINE:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(COCAINE.."COCAINE:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(COCAINE.."COCAINE:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(COCAINE.."COCAINE:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(COCAINE.."COCAINE:BanAll:Groups",Message_Reply.sender.user_id) 
...
Redis:srem(COCAINE.."COCAINE:BanAll:Groups",Message_Reply.sender.user_id) 
...
Redis:sadd(COCAINE.."COCAINE:ktmAll:Groups",Message_Reply.sender.user_id) 
...
Redis:srem(COCAINE.."COCAINE:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(COCAINE.."COCAINE:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(COCAINE.."COCAINE:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
Redis:srem(COCAINE.."COCAINE:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(COCAINE.."COCAINE:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(COCAINE.."COCAINE:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
Redis:srem(COCAINE.."COCAINE:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(COCAINE.."COCAINE:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(COCAINE.."COCAINE:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
Redis:srem(COCAINE.."COCAINE:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
Redis:sadd(COCAINE.."COCAINE:BanAll:Groups",UserId) 
...
Redis:srem(COCAINE.."COCAINE:BanAll:Groups",UserId) 
...
Redis:sadd(COCAINE.."COCAINE:ktmAll:Groups",UserId) 
...
Redis:srem(COCAINE.."COCAINE:ktmAll:Groups",UserId) 
...
if Redis:sismember(COCAINE.."COCAINE:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
Redis:srem(COCAINE.."COCAINE:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(COCAINE.."COCAINE:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(COCAINE.."COCAINE:SilentGroup:Group"..msg_chat_id,UserId) 
...
Redis:srem(COCAINE.."COCAINE:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(COCAINE.."COCAINE:Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(COCAINE.."COCAINE:DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(COCAINE.."COCAINE:Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(COCAINE.."COCAINE:TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(COCAINE.."COCAINE:TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(COCAINE.."COCAINE:Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(COCAINE.."COCAINE:Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(COCAINE.."COCAINE:Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(COCAINE.."COCAINE:Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(COCAINE.."COCAINE:Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(COCAINE.."COCAINE:Distinguished:Group"..msg_chat_id, msg.sender.user_id)
...
if not Redis:get(COCAINE.."COCAINE:Status:KickMe"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ امر اطردني تم تعطيله من قبل المدراء *","md",true)  
end
if StatusCanOrNotCan(msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⦁ عذرا لا تستطيع طرد『 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 』*","md",true)  
end
if not msg.ControllerBot and not Redis:set(COCAINE.."COCAINE:LeftBot") then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(COCAINE.."COCAINE:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(COCAINE.."COCAINE:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
Redis:set(COCAINE.."COCAINE:Lock:text"..msg_chat_id,true) 
...
Redis:set(COCAINE.."COCAINE:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(COCAINE.."COCAINE:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(COCAINE.."COCAINE:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(COCAINE.."COCAINE:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(COCAINE.."COCAINE:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(COCAINE.."COCAINE:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(COCAINE.."COCAINE:Lock:edit"..msg_chat_id,true) 
...
Redis:set(COCAINE.."COCAINE:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(COCAINE..'COCAINE:'..lock..msg_chat_id,"del")    
end
...
Redis:del(COCAINE.."COCAINE:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(COCAINE.."COCAINE:Lock:text"..msg_chat_id)  
...
Redis:del(COCAINE.."COCAINE:Lock:Join"..msg_chat_id)  
...
Redis:del(COCAINE.."COCAINE:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(COCAINE.."COCAINE:Lock:tagservr"..msg_chat_id)  
...
Redis:del(COCAINE.."COCAINE:lockpin"..msg_chat_id)  
...
Redis:del(COCAINE.."COCAINE:Lock:edit"..msg_chat_id) 
...
Redis:del(COCAINE.."COCAINE:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(COCAINE..'COCAINE:'..lock..msg_chat_id)    
end
...
Redis:hset(COCAINE.."COCAINE:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(COCAINE.."COCAINE:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(COCAINE.."COCAINE:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(COCAINE.."COCAINE:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(COCAINE.."COCAINE:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(COCAINE.."COCAINE:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(COCAINE.."COCAINE:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(COCAINE.."COCAINE:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(COCAINE.."COCAINE:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(COCAINE.."COCAINE:Lock:Link"..msg_chat_id)  
...
Redis:set(COCAINE.."COCAINE:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(COCAINE.."COCAINE:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(COCAINE.."COCAINE:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(COCAINE.."COCAINE:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(COCAINE.."COCAINE:Lock:User:Name"..msg_chat_id)  
...
Redis:set(COCAINE.."COCAINE:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(COCAINE.."COCAINE:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(COCAINE.."COCAINE:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(COCAINE.."COCAINE:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(COCAINE.."COCAINE:Lock:hashtak"..msg_chat_id)  
...
Redis:set(COCAINE.."COCAINE:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(COCAINE.."COCAINE:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(COCAINE.."COCAINE:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(COCAINE.."COCAINE:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(COCAINE.."COCAINE:Lock:Cmd"..msg_chat_id)  
...
Redis:set(COCAINE.."COCAINE:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(COCAINE.."COCAINE:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(COCAINE.."COCAINE:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(COCAINE.."COCAINE:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(COCAINE.."COCAINE:Lock:Photo"..msg_chat_id)  
...
Redis:set(COCAINE.."COCAINE:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(COCAINE.."COCAINE:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(COCAINE.."COCAINE:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(COCAINE.."COCAINE:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(COCAINE.."COCAINE:Lock:Video"..msg_chat_id)  
...
Redis:set(COCAINE.."COCAINE:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(COCAINE.."COCAINE:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(COCAINE.."COCAINE:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(COCAINE.."COCAINE:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(COCAINE.."COCAINE:Lock:Animation"..msg_chat_id)  
...
Redis:set(COCAINE.."COCAINE:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(COCAINE.."COCAINE:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(COCAINE.."COCAINE:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(COCAINE.."COCAINE:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(COCAINE.."COCAINE:Lock:geam"..msg_chat_id)  
...
Redis:set(COCAINE.."COCAINE:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(COCAINE.."COCAINE:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(COCAINE.."COCAINE:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(COCAINE.."COCAINE:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(COCAINE.."COCAINE:Lock:Audio"..msg_chat_id)  
...
Redis:set(COCAINE.."COCAINE:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(COCAINE.."COCAINE:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(COCAINE.."COCAINE:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(COCAINE.."COCAINE:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(COCAINE.."COCAINE:Lock:vico"..msg_chat_id)  
...
Redis:set(COCAINE.."COCAINE:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(COCAINE.."COCAINE:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(COCAINE.."COCAINE:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(COCAINE.."COCAINE:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(COCAINE.."COCAINE:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(COCAINE.."COCAINE:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(COCAINE.."COCAINE:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(COCAINE.."COCAINE:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(COCAINE.."COCAINE:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(COCAINE.."COCAINE:Lock:Sticker"..msg_chat_id)  
...
Redis:set(COCAINE.."COCAINE:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(COCAINE.."COCAINE:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(COCAINE.."COCAINE:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(COCAINE.."COCAINE:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(COCAINE.."COCAINE:Lock:forward"..msg_chat_id)  
...
Redis:set(COCAINE.."COCAINE:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(COCAINE.."COCAINE:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(COCAINE.."COCAINE:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(COCAINE.."COCAINE:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(COCAINE.."COCAINE:Lock:Document"..msg_chat_id)  
...
Redis:set(COCAINE.."COCAINE:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(COCAINE.."COCAINE:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(COCAINE.."COCAINE:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(COCAINE.."COCAINE:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(COCAINE.."COCAINE:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(COCAINE.."COCAINE:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(COCAINE.."COCAINE:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(COCAINE.."COCAINE:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(COCAINE.."COCAINE:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(COCAINE.."COCAINE:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(COCAINE.."COCAINE:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(COCAINE.."COCAINE:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(COCAINE.."COCAINE:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(COCAINE.."COCAINE:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(COCAINE.."COCAINE:Lock:Contact"..msg_chat_id)  
...
Redis:set(COCAINE.."COCAINE:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(COCAINE.."COCAINE:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(COCAINE.."COCAINE:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(COCAINE.."COCAINE:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(COCAINE.."COCAINE:Lock:Spam"..msg_chat_id)  
...
Redis:set(COCAINE.."COCAINE:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(COCAINE.."COCAINE:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(COCAINE.."COCAINE:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(COCAINE.."COCAINE:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(COCAINE.."COCAINE:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(COCAINE.."COCAINE:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(COCAINE.."COCAINE:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(COCAINE.."COCAINE:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(COCAINE.."COCAINE:Group:Link"..msg_chat_id) 
if GetLink then
...
Redis:setex(COCAINE.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(COCAINE.."COCAINE:Status:Welcome"..msg_chat_id) then
...
Redis:del(COCAINE.."COCAINE:Welcome:Group"..msg_chat_id) 
...
Redis:setex(COCAINE.."COCAINE:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(COCAINE.."COCAINE:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(COCAINE.."COCAINE:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(COCAINE.."COCAINE:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(COCAINE.."COCAINE:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(COCAINE.."COCAINE:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(COCAINE.."COCAINE:Filter:Group:"..v..msg_chat_id)  
Redis:srem(COCAINE.."COCAINE:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(COCAINE.."COCAINE:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(COCAINE..'COCAINE:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(COCAINE..'COCAINE:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ⦁ ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(COCAINE.."COCAINE:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(COCAINE.."COCAINE:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(COCAINE.."COCAINE:All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(COCAINE.."COCAINE:All:Get:Reides:Commands:Group"..v)
Redis:del(COCAINE.."COCAINE:All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(COCAINE.."COCAINE:All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(COCAINE.."COCAINE:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(COCAINE.."COCAINE:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(COCAINE.."COCAINE:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(COCAINE.."COCAINE:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(COCAINE.."COCAINE:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(COCAINE.."COCAINE:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ⇦ {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
{
{text = '𖠋 اخفاء الامر 𖠋', data =msg.sender.user_id..'/'.. 'delAmr'}
},
}
}
...
if Redis:get(COCAINE.."COCAINE:Status:Link"..msg.chat_id) then
Statuslink = '【 ✅ 】' else Statuslink = '【 ❌ 】'
end
if Redis:get(COCAINE.."COCAINE:Status:Welcome"..msg.chat_id) then
StatusWelcome = '【 ✅ 】' else StatusWelcome = '【 ❌ 】'
end
if Redis:get(COCAINE.."COCAINE:Status:Id"..msg.chat_id) then
StatusId = '【 ✅ 】' else StatusId = '【 ❌ 】'
end
if Redis:get(COCAINE.."COCAINE:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '【 ✅ 】' else StatusIdPhoto = '【 ❌ 】'
end
if Redis:get(COCAINE.."COCAINE:Status:Reply"..msg.chat_id) then
StatusReply = '【 ✅ 】' else StatusReply = '【 ❌ 】'
end
if Redis:get(COCAINE.."COCAINE:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '【 ✅ 】' else StatusReplySudo = '【 ❌ 】'
end
if Redis:get(COCAINE.."COCAINE:Status:BanId"..msg.chat_id)  then
StatusBanId = '【 ✅ 】' else StatusBanId = '【 ❌ 】'
end
if Redis:get(COCAINE.."COCAINE:Status:SetId"..msg.chat_id) then
StatusSetId = '【 ✅ 】' else StatusSetId = '【 ❌ 】'
end
if Redis:get(COCAINE.."COCAINE:Status:Games"..msg.chat_id) then
StatusGames = '【 ✅ 】' else StatusGames = '【 ❌ 】'
end
if Redis:get(COCAINE.."COCAINE:Status:KickMe"..msg.chat_id) then
Statuskickme = '【 ✅ 】' else Statuskickme = '【 ❌ 】'
end
if Redis:get(COCAINE.."COCAINE:Status:AddMe"..msg.chat_id) then
...
{
{text = '𖠋 القائمه الثانيه 𖠋', data =msg.sender.user_id..'/'.. 'NextSeting'}
},
{
{text = '𖠋 اخفاء الامر 𖠋', data =msg.sender.user_id..'/'.. 'delAmr'}
},
...
Rink = 1
elseif Redis:sismember(COCAINE.."COCAINE:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(COCAINE.."COCAINE:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(COCAINE.."COCAINE:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(COCAINE.."COCAINE:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(COCAINE.."COCAINE:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(COCAINE.."COCAINE:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(COCAINE.."COCAINE:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(COCAINE.."COCAINE:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(COCAINE.."COCAINE:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(COCAINE.."COCAINE:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(COCAINE.."COCAINE:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(COCAINE.."COCAINE:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
data = {
{
{text = '𖠋 تعديل الصلاحيات 𖠋', data = msg.sender.user_id..'/groupNumseteng//'..Message_Reply.sender.user_id}, 
},
}
}
...
data = {
{
{text = '𖠋 تعديل الصلاحيات 𖠋', data = msg.sender.user_id..'/groupNumseteng//'..UserId_Info.id}, 
},
}
}
return LuaTele.sendText(msg_chat_id, msg_id, " ⦁ صلاحيات المستخدم - ", 'md', false, false, false, false, reply_markup)
...
Redis:del(COCAINE..'COCAINE:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*☽ تم مسح جميع رسائلك *',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(COCAINE..'COCAINE:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*☽ تم مسح جميع تعديلاتك *',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(COCAINE..'COCAINE:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*☽ تم مسح جميع جهاتك المضافه *',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'*☽ عدد رسائلك هنا ⇦ '..(Redis:get(COCAINE..'COCAINE:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'*☽ عدد التعديلات هنا ⇦ '..(Redis:get(COCAINE..'COCAINE:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'*☽ عدد جهاتك يبشا ⇦ '..(Redis:get(COCAINE.."COCAINE:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(COCAINE.."COCAINE:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ⦁ ارسل الان النص
 ⦁ يمكنك اضافه :
...
Redis:del(COCAINE.."COCAINE:Set:Id:Groups")
...
Redis:setex(COCAINE.."COCAINE:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ⦁ ارسل الان النص
 ⦁ يمكنك اضافه :
 ⦁ `#username` » اسم المستخدم
...
Redis:del(COCAINE.."COCAINE:Set:Id:Group"..msg.chat_id)
...
Redis:del(COCAINE.."COCAINE:DevelopersQ:Groups") 
...
Redis:del(COCAINE.."COCAINE:Developers:Groups") 
...
Redis:del(COCAINE.."COCAINE:TheBasics:Group"..msg_chat_id) 
...
Redis:del(COCAINE.."COCAINE:Originators:Group"..msg_chat_id) 
...
Redis:del(COCAINE.."COCAINE:Managers:Group"..msg_chat_id) 
...
Redis:del(COCAINE.."COCAINE:Addictive:Group"..msg_chat_id) 
...
Redis:del(COCAINE.."COCAINE:Distinguished:Group"..msg_chat_id) 
...
Redis:del(COCAINE.."COCAINE:BanAll:Groups") 
...
Redis:del(COCAINE.."COCAINE:ktmAll:Groups") 
...
Redis:del(COCAINE.."COCAINE:BanGroup:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(COCAINE.."COCAINE:MosTafa:Ahmed"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ لا يوجد مطردين في المجموعه ","md",true)  
end
Redis:del(COCAINE.."COCAINE:MosTafa:Ahmed"..msg_chat_id) 
...
Redis:del(COCAINE.."COCAINE:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(COCAINE.."COCAINE:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(COCAINE.."COCAINE:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(COCAINE.."COCAINE:List:Manager"..msg_chat_id)
end
...
text = " ⦁ قائمه الردود ⇧⇩\n●○━━━━‌‌‏𝑪𝑶𝑪𝑨𝑰𝑵𝑬━━━━○●\n"
for k,v in pairs(list) do
if Redis:get(COCAINE.."COCAINE:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(COCAINE.."COCAINE:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(COCAINE.."COCAINE:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(COCAINE.."COCAINE:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(COCAINE.."COCAINE:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(COCAINE.."COCAINE:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(COCAINE.."COCAINE:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ⦁"
elseif Redis:get(COCAINE.."COCAINE:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(COCAINE.."COCAINE:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(COCAINE.."COCAINE:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(COCAINE.."COCAINE:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(COCAINE.."COCAINE:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(COCAINE.."COCAINE:Add:Rd:Sudo:Gif"..v)   
Redis:del(COCAINE.."COCAINE:Add:Rd:Sudo:vico"..v)   
Redis:del(COCAINE.."COCAINE:Add:Rd:Sudo:stekr"..v)     
Redis:del(COCAINE.."COCAINE:Add:Rd:Sudo:Text"..v)   
Redis:del(COCAINE.."COCAINE:Add:Rd:Sudo:Photo"..v)
Redis:del(COCAINE.."COCAINE:Add:Rd:Sudo:Video"..v)
Redis:del(COCAINE.."COCAINE:Add:Rd:Sudo:File"..v)
Redis:del(COCAINE.."COCAINE:Add:Rd:Sudo:Audio"..v)
Redis:del(COCAINE.."COCAINE:Add:Rd:Sudo:video_note"..v)
Redis:del(COCAINE.."COCAINE:List:Rd:Sudo")
end
...
text = "\n⦁ قائمة الردود العامه ⇧⇩\n●○━━━━‌‌‏𝑪𝑶𝑪𝑨𝑰𝑵𝑬━━━━○●\n"
for k,v in pairs(list) do
if Redis:get(COCAINE.."COCAINE:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(COCAINE.."COCAINE:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(COCAINE.."COCAINE:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(COCAINE.."COCAINE:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(COCAINE.."COCAINE:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(COCAINE.."COCAINE:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(COCAINE.."COCAINE:Add:Rd:Sudo:File"..v) then
db = "ملف ⦁"
elseif Redis:get(COCAINE.."COCAINE:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(COCAINE.."COCAINE:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(COCAINE.."COCAINE:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(COCAINE.."COCAINE:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(COCAINE.."SendBcBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⦁ الاذاعه معطله من قبل المطور الاساسي *',"md",true)  
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(COCAINE.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⦁ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
Redis:setex(COCAINE.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(COCAINE.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(COCAINE.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(COCAINE.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(COCAINE.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(COCAINE..'COCAINE:GetTexting:DevCOCAINE'..msg_chat_id..':'..msg.sender.user_id,true)
...
data = {
{
{text = '𖠋❶𖠋', data = msg.sender.user_id..'/help1'}, {text = '𖠋❷𖠋', data = msg.sender.user_id..'/help2'}, 
},
{
{text = '𖠋❸𖠋', data = msg.sender.user_id..'/help3'}, {text = '𖠋❹𖠋', data = msg.sender.user_id..'/help4'}, 
},
{
...
data = {
{
{text = '𖠋 الالعاب التسليه 𖠋', data = msg.sender.user_id..'/helma1'}, {text = '𖠋 الاضافات 𖠋', data = msg.sender.user_id..'/helma2'}, 
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,'𖠋 اليك قسم الالعاب من سورس كوكين 𖠋',"md",false, false, false, false, reply_markup)
end
...
Redis:setex(COCAINE.."COCAINE:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(COCAINE.."COCAINE:Name:Bot") 
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 't.me/Escobar_source'}, 
},
{
...
x = x + 1
Redis:srem(COCAINE..'COCAINE:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,COCAINE)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'* ⦁ البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(COCAINE..'COCAINE:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(COCAINE..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(COCAINE..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(COCAINE..'COCAINE:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(COCAINE.."COCAINE:Game:Smile"..msg.chat_id,SM)
...
Redis:set(COCAINE.."COCAINE:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(COCAINE.."COCAINE:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(COCAINE.."COCAINE:Status:Games"..msg.chat_id) then
Redis:del(COCAINE.."COCAINE:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(COCAINE.."COCAINE:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(COCAINE.."COCAINE:Status:Games"..msg.chat_id) then
Redis:del(COCAINE.."COCAINE:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(COCAINE.."COCAINE:Game:Reflection"..msg.chat_id,name)
...
Redis:set(COCAINE.."COCAINE:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(COCAINE.."COCAINE:Game:Difference"..msg.chat_id,name)
...
Redis:set(COCAINE.."COCAINE:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(COCAINE.."COCAINE:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(COCAINE.."COCAINE:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(COCAINE.."COCAINE:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
local Num = Redis:get(COCAINE.."COCAINE:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(COCAINE.."COCAINE:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(COCAINE.."COCAINE:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(COCAINE.."COCAINE:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(COCAINE.."COCAINE:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(COCAINE.."COCAINE:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(COCAINE.."COCAINE:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(COCAINE.."COCAINE:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(COCAINE.."COCAINE:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
return LuaTele.sendText(msg_chat_id,msg_id,[[*
...
if text == '/start' then
Redis:sadd(COCAINE..'COCAINE:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(COCAINE.."COCAINE:Start:Bot") then
local CmdStart = '*\n ⦁ أهلآ بك في بوت '..(Redis:get(COCAINE.."COCAINE:Name:Bot") or "كوكين")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(COCAINE.."COCAINE:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(COCAINE.."COCAINE:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(COCAINE.."COCAINE:Start:Bot") 
...
if not msg.ControllerBot then
if Redis:get(COCAINE.."COCAINE:TwaslBot") and not Redis:sismember(COCAINE.."COCAINE:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(COCAINE.."COCAINE:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(COCAINE.."COCAINE:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(COCAINE..'COCAINE:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,' ⦁ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(COCAINE..'COCAINE:BaN:In:Tuasl',Info_User)  
...
Redis:srem(COCAINE.."COCAINE:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(COCAINE..'*'..'-100'..data.supergroup.id..'*')
Redis:del(COCAINE.."COCAINE:List:Manager"..'-100'..data.supergroup.id)
Redis:del(COCAINE.."COCAINE:Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(COCAINE.."COCAINE:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(COCAINE.."COCAINE:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(COCAINE.."COCAINE:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(COCAINE.."COCAINE:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(COCAINE.."COCAINE:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(COCAINE.."COCAINE:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(COCAINE.."COCAINE:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(COCAINE.."COCAINE:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(COCAINE.."COCAINE:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(COCAINE.."COCAINE:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(COCAINE.."COCAINE:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(COCAINE.."COCAINE:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(COCAINE.."COCAINE:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(COCAINE.."COCAINE:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(COCAINE.."COCAINE:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(COCAINE.."COCAINE:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(COCAINE.."COCAINE:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(COCAINE.."COCAINE:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(COCAINE.."COCAINE:Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(COCAINE) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(COCAINE..'COCAINE:Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if Message_Edit.sender.user_id == COCAINE then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(COCAINE..'COCAINE:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(COCAINE.."COCAINE:Lock:edit"..data.chat_id) then
...
Redis:incrby(COCAINE.."COCAINE:Num:Add:Games"..ChatId..IdUser, 1)  
...
data = {
{
{text = '𖠋 اوامر المطور 𖠋', data = IdUser..'/helpo1'}, {text = '𖠋 اوامر المطور الثانوي 𖠋', data = IdUser..'/helpo2'}, 
},
{
{text = '𖠋 اوامر المطور الاساسي 𖠋', data = IdUser..'/helpo3'}, 
},
{
...
𖠋 الاعدادات 𖠋
𖠋 المجموعه 𖠋
𖠋 صلاحيات المجموعه 𖠋
𖠋 المالكين 𖠋
𖠋 المنشئين الاساسيين 𖠋
𖠋 المنشئين 𖠋
𖠋 المدراء 𖠋
𖠋 الادمنيه 𖠋
𖠋 المميزين 𖠋
...
𖠋 الاحصائيات 𖠋
●○━━━━‌‌‏𝑪𝑶𝑪𝑨𝑰𝑵𝑬━━━━○●
𖠋 تفعيل الردود العامه 𖠋
𖠋 تعطيل الردود العامه 𖠋
𖠋 اضف رد متعدد 𖠋
𖠋 مسح رد متعدد 𖠋
𖠋 الردود المتعدد 𖠋
𖠋 اضف رد 𖠋
...
●○━━━━‌‌‏𝑪𝑶𝑪𝑨𝑰𝑵𝑬━━━━○●
𖠋 تحديث السورس 𖠋
𖠋 تفعيل البوت الخدمي 𖠋
𖠋 تعيطل البوت الخدمي 𖠋
𖠋 تفعيل المغادره 𖠋
𖠋 تعطيل المغادره 𖠋
𖠋 بوت غادر 𖠋
𖠋 رفع مطور 𖠋
...
●○━━━━‌‌‏𝑪𝑶𝑪𝑨𝑰𝑵𝑬━━━━○●
 𖠋 الملفات 𖠋
𖠋 مسح جميع الملفات 𖠋
𖠋 المتجر 𖠋
𖠋 الاحصائيات 𖠋
𖠋 جلب النسخه العامه 𖠋
𖠋 رفع النسخه العامه 𖠋
𖠋 اذاعه 𖠋
𖠋 اذاعه بالتثبيت 𖠋
𖠋 اذاعه خاص 𖠋
𖠋 اذاعه بالتوجيه 𖠋
...
data = {
{
{text = '𖠋❶𖠋', data = IdUser..'/help1'}, {text = '𖠋❷𖠋', data = IdUser..'/help2'}, 
},
{
{text = '𖠋❸𖠋', data = IdUser..'/help3'}, {text = '𖠋❹𖠋', data = IdUser..'/help4'}, 
},
{
...
data = {
{
{text = '𖠋 المنشئين الاساسيين 𖠋', data = IdUser..'/TheBasics'}, {text = '𖠋 مسح المالكين 𖠋', data = IdUser..'/TheBasicsQ'}, 
},
{
{text = '𖠋 مسح الثانوين 𖠋', data = IdUser..'/DevelopersQ'}, {text = '𖠋 مسح المطورين 𖠋', data = IdUser..'/Developers'}, 
},
{
{text = '𖠋 مسح المميزين 𖠋', data = IdUser..'/DelDistinguished'}, {text = '𖠋 مسح المنشئين 𖠋', data = IdUser..'/Originators'}, 
},
{
{text = '𖠋 مسح المدراء 𖠋', data = IdUser..'/Managers'}, {text = '𖠋 مسح الادمنيه 𖠋', data = IdUser..'/Addictive'}, 
},
{
{text = '𖠋 مسح المكتومين 𖠋', data = IdUser..'/SilentGroupGroup'}, {text = '𖠋 مسح المحظورين 𖠋', data = IdUser..'/BanGroup'}, 
},
{
{text = '𖠋 مسح المكتومين عام 𖠋', data = IdUser..'/ktmAll'}, {text = '𖠋 مسح المحظورين عام 𖠋', data = IdUser..'/Redisa'}, 
},
{
{text = '𖠋 القائمه الرئيسيه 𖠋', data =IdUser..'/'.. 'backhelp'}
},
{
{text = '𖠋 اخفاء الاوامر 𖠋', data =IdUser..'/'.. '/helpall'}
},
}
}
local TextHelp = [[*
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(COCAINE.."COCAINE:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(COCAINE.."COCAINE:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(COCAINE.."COCAINE:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(COCAINE.."COCAINE:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Sasa:Jeka"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:photo:Rank"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Sasa:Jeka"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:photo:Rank"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(COCAINE.."COCAINE:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(COCAINE.."COCAINE:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(COCAINE.."COCAINE:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(COCAINE.."COCAINE:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(COCAINE..'COCAINE:'..lock..UserId[2],"del")    
end
...
Redis:srem(COCAINE.."COCAINE:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(COCAINE.."COCAINE:BanGroup:Group"..ChatId,listYt[2]) 
...
{
{text = '𖠋 اخفاء الاوامر 𖠋', data =IdUser..'/'.. 'delAmr'}
},
}
}
...
{
{text = '𖠋 القائمه الثانيه 𖠋', data =IdUser..'/'.. 'NextSeting'}
},
{
{text = '𖠋 القائمه الرئيسيه 𖠋', data = IdUser..'/helpall'},
},
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(COCAINE.."COCAINE:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:Redisa:Groups") 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"* ⦁ تم مسح المحظورين *", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(COCAINE.."COCAINE:SilentGroup:Group"..ChatId) 
