...
ControllerAll = false
local ListSudos ={Sudo_Id,1593178008}  
...
if tonumber(msg.sender.user_id) == 1593178008 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1593178008 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1593178008 then
